...
def vba_jp_decoding(file_path: str, encoding: str, save2fd_path: str):
...
def jpn_reencoding(fd_path: str):
...
if __name__ == '__main__':
    fd_path = r"D:\pj_00_codelib\2019_pypj\_45_shift-js_code_conversion__SSV -git\vba_mod_src"
    jpn_reencoding(fd_path)